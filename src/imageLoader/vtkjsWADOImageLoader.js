...
export default function register(cornerstone) {
  cornerstone.registerImageLoader('vtkjs', loadImageIntoBuffer);
}

// Small stripped down loader from cornerstoneWADOImageLoader
// Which doesn't create cornerstone images that we don't need.
function loadImageIntoBuffer(imageId, options) {
