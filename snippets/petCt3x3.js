...
// get example
// someLayout = VTKLayout.getLayoutByUID('monitor1);
...
const orthogonalManipulationGroup = {
  UID: 'orthogonalManipulation',
  tools: [
    {
      toolName: 'pan',
...
// layout.addToolGroup(orthogonalManipulationGroup);
...
const ptWindowLevelSyncGroup = {
  eventName: 'voiChange',
  synchronizer: updateVoiSynchronizer,
  UID: 'ptWindowLevelSyncGroup',
};
...
const ctSceneViewports = ctScene.getViewports();

ctSceneViewports.setToolGroups(['ctWindowLevel', 'orthogonalManipulation']);
ctSceneViewports.setSyncGroups(['ctWindowLevelSyncGroup']);

const ptSceneViewports = ptScene.getViewports();

ptSceneViewports.setToolGroups(['ptWindowLevel', 'orthogonalManipulation']);
ptSceneViewports.setSyncGroups(['ptWindowLevelSyncGroup']);

const fusionSceneViewports = fusionScene.getViewports();

fusionSceneViewports.setToolGroups(['orthogonalManipulation']);
fusionSceneViewports.setSyncGroups([
  'ctWindowLevelSyncGroup',
  'ptWindowLevelSyncGroup',
]);

// Rotatable crosshairs
// const rotatableCrosshairsGroup = {
//   UID: 'rotatableCrosshairs',
//   tools: [
//     {
//       toolName: 'wwwc',
//       button: toolManager.buttons.LEFT,
//       options: {
//         viewportUIDS: ['1', '2', '3'], // Volume to manipulate window level of
//       },
//     },
//   ],
// };
