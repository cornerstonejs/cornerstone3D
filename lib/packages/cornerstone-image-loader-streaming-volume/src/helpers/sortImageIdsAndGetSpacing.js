 ...
 */
export default function sortImageIdsAndGetSpacing(imageIds, scanAxisNormal // Get gl matrix types?
) {
    ...
    const zSpacing = Math.abs(distanceImagePairs[numImages - 1].distance -
