import { registerVolumeLoader, registerUnknownVolumeLoader, cache, Utilities, } from '@ohif/cornerstone-render';
...
function cornerstoneStreamingImageVolumeLoader(volumeId, options) {
    ...
    const sizeInBytes = bytesPerVoxel * dimensions[0] * dimensions[1] * dimensions[2];
    let numComponents = 1;
