...
const EXAMPLE = 'volumeAnnotationTools';
...
test.describe('Volume Annotation - Legacy', () => {
  test.beforeEach(navigateToExample());

  test('should draw a length measurement (legacy)', async ({ page }) => {
    const locator = getVisibleViewportCanvas(page, 0);
    await drawLengthMeasurement(page, locator);
    await checkForScreenshot(
      page,
      locator,
      screenShotPaths.volumeAnnotationNext.legacyLength
    );
  });

  test('should draw a length measurement on sagittal (legacy)', async ({
    page,
  }) => {
    const sagittal = getVisibleViewportCanvas(page, 1);
    ...
    await checkForScreenshot(
      page,
      sagittal,
      screenShotPaths.volumeAnnotationNext.legacySagittal
    );
  });

  test('should scroll, zoom, and pan all viewports (legacy)', async ({
    page,
  }) => {
    await manipulateAndScreenshotAll(page, {
      axial: screenShotPaths.volumeAnnotationNext.legacyAxialManip,
      sagittal: screenShotPaths.volumeAnnotationNext.legacySagittalManip,
      coronal: screenShotPaths.volumeAnnotationNext.legacyCoronalManip,
    });
  });
});
...
test.describe('Volume Annotation - Next (GPU)', () => {
  ...
  test('should draw a length measurement (next GPU)', async ({ page }) => {
    ...
    await checkForScreenshot(
      page,
      locator,
      screenShotPaths.volumeAnnotationNext.nextLength
    );
  });
  ...
  test('should draw a length measurement on sagittal (next GPU)', async ({
    ...
    await checkForScreenshot(
      page,
      sagittal,
      screenShotPaths.volumeAnnotationNext.nextSagittal
    );
  });
  ...
  test('should scroll, zoom, and pan all viewports (next GPU)', async ({
    ...
    await manipulateAndScreenshotAll(page, {
      axial: screenShotPaths.volumeAnnotationNext.nextAxialManip,
      sagittal: screenShotPaths.volumeAnnotationNext.nextSagittalManip,
      coronal: screenShotPaths.volumeAnnotationNext.nextCoronalManip,
    });
  });
});
...
test.describe('Volume Annotation - Next (CPU)', () => {
  ...
  test('should draw a length measurement (next CPU)', async ({ page }) => {
    ...
    await checkForScreenshot(
      page,
      locator,
      screenShotPaths.volumeAnnotationNext.nextCpuLength
    );
  });
  ...
  test('should draw a length measurement on sagittal (next CPU)', async ({
    ...
    await checkForScreenshot(
      page,
      sagittal,
      screenShotPaths.volumeAnnotationNext.nextCpuSagittal
    );
  });
  ...
  test('should scroll, zoom, and pan all viewports (next CPU)', async ({
    ...
    await manipulateAndScreenshotAll(page, {
      axial: screenShotPaths.volumeAnnotationNext.nextCpuAxialManip,
      sagittal: screenShotPaths.volumeAnnotationNext.nextCpuSagittalManip,
      coronal: screenShotPaths.volumeAnnotationNext.nextCpuCoronalManip,
    });
  });
});
