...
const screenShotPaths = {
  ...
  stackManipulationToolsNext: {
    legacyZoom: 'legacy-zoom.png',
    legacyPan: 'legacy-pan.png',
    legacyZoomAndPan: 'legacy-zoom-and-pan.png',
    nextZoom: 'next-zoom.png',
    nextPan: 'next-pan.png',
    nextZoomAndPan: 'next-zoom-and-pan.png',
    nextCpuZoom: 'next-cpu-zoom.png',
    nextCpuPan: 'next-cpu-pan.png',
    nextCpuZoomAndPan: 'next-cpu-zoom-and-pan.png',
  },
  stackProperties: {
    nextImage: 'nextImage.png',
    previousImage: 'previousImage.png',
  ...
  labelmapRenderingNext: {
    ...
    nextCpuAxial: 'next-cpu-axial.png',
    nextCpuCoronal: 'next-cpu-coronal.png',
    nextCpuSagittal: 'next-cpu-sagittal.png',
  },
  ...
  volumeAnnotationNext: {
    legacyLength: 'legacy-length.png',
    legacySagittal: 'legacy-sagittal.png',
    legacyAxialManip: 'legacy-axial-manip.png',
    legacySagittalManip: 'legacy-sagittal-manip.png',
    legacyCoronalManip: 'legacy-coronal-manip.png',
    nextLength: 'next-length.png',
    nextSagittal: 'next-sagittal.png',
    nextAxialManip: 'next-axial-manip.png',
    nextSagittalManip: 'next-sagittal-manip.png',
    nextCoronalManip: 'next-coronal-manip.png',
    nextCpuLength: 'next-cpu-length.png',
    nextCpuSagittal: 'next-cpu-sagittal.png',
    nextCpuAxialManip: 'next-cpu-axial-manip.png',
    nextCpuSagittalManip: 'next-cpu-sagittal-manip.png',
    nextCpuCoronalManip: 'next-cpu-coronal-manip.png',
  },
  wsiNext: {
  ...
  labelmapSegToolsNext: {
    ...
    nextCpuSphereBrush: 'next-cpu-sphereBrush.png',
  },
  stackLabelmapSegNext: {
    legacyBrush: 'legacy-brush.png',
  ...
  stackAPINext: {
    ...
    legacyFlipH: 'legacy-flipH.png',
    legacyRotate: 'legacy-rotate.png',
    legacyInvert: 'legacy-invert.png',
    legacyReset: 'legacy-reset.png',
    nextSetVoi: 'next-setVoi.png',
    nextNextImage: 'next-nextImage.png',
    nextFlipH: 'next-flipH.png',
    nextRotate: 'next-rotate.png',
    nextInvert: 'next-invert.png',
    nextReset: 'next-reset.png',
    nextCpuSetVoi: 'next-cpu-setVoi.png',
    nextCpuNextImage: 'next-cpu-nextImage.png',
    nextCpuFlipH: 'next-cpu-flipH.png',
    nextCpuRotate: 'next-cpu-rotate.png',
    nextCpuInvert: 'next-cpu-invert.png',
    nextCpuReset: 'next-cpu-reset.png',
  },
