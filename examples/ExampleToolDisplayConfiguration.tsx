    ...
    return (
      <div>
        <div>
          ...
          <p>
            Demo for testing selection and styling options for annotations
            (aka tool data). In order to select multiple items or deselect a
        ...
        <div className="tool-style-controls">
          ...
          <div className="controls-wrapper">
            <div className="control-elements">
              <label>Target:</label>
              <input type="text" id="output-target" name="ouput-target" placeholder="Runtime Settings" disabled={true} />
...
function displayToolStyleValues() {
  ...
  const nodeList = document.querySelectorAll('.tool-style-controls .input-elements .tool-style-control input')
