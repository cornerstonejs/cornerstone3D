...
/**
 * The getTypedValue is the direct-use name for this, while the typedProviderProvider
 * is the name for registering it with the typed provider.  In the future these
 * may be different functions.
 */
export const getTypedValue = typedProviderProvider;
...
/** Sets the typed value to the given object */
export function setTypedValue(type: string, value) {
