...
enum Events {
   ...
   * and see what event detail is included in {@link EventTypes.CameraModifiedEventData | CameraModified Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.VoiModifiedEventData | VoiModified Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ElementDisabledEventData | ElementDisabled Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ElementEnabledEventData | ElementEnabled Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageRenderedEventData | ImageRendered Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageVolumeModifiedEventData | ImageVolumeModified Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageLoadedEventData | ImageLoaded Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageLoadedFailedEventData | ImageLoadedFailed Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.VolumeLoadedEventData | VolumeLoaded Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.VolumeLoadedFailedEventData | VolumeLoadedFailed Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageCacheImageAddedEventData | ImageCacheAdded Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageCacheImageRemovedEventData | ImageCacheRemoved Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.VolumeCacheVolumeAddedEventData | VolumeCacheAdded Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.VolumeCacheVolumeRemovedEventData | VolumeCacheRemoved Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.StackNewImageEventData | StackNewImage Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageSpacingCalibratedEventData | ImageSpacingCalibrated Event Data }
   */
   ...
   * and see what event detail is included in {@link EventTypes.ImageLoadProgressEventData | ImageLoadProgress Event Data }
   */
