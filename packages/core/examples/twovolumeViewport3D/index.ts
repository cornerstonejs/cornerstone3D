...
async function run() {
  ...
  const imageIds2 = await createImageIdsAndCacheMetaData({
    StudyInstanceUID:
      '1.2.826.0.1.3680043.9.4245.3055329863626706991980010968025224339',
    SeriesInstanceUID:
      '1.2.826.0.1.3680043.9.4245.9629042897282277742576659996878568544',
