# Cornerstone3D v5 Viewport Next Migration
...
```sh
npx codemod cornerstone3d/5/viewport-next --dry-run
```
...
```sh
yarn test
npx codemod workflow validate -w registry/cornerstone3d/5/viewport-next
```
