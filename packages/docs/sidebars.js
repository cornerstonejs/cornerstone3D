  ...
  docs: [
      ...
      items: [
        {
          ...
          items: [
            ...
            {
              type: 'category',
              label: 'Generic Viewport',
              collapsed: true,
              link: {
                type: 'doc',
                id: 'concepts/cornerstone-core/generic-viewport/index',
              },
              items: [
    ...
    },
    {
      ...
      link: {
        ...
        description:
          'What the user expects from cornerstone3D, written per feature',
      },
      collapsed: true,
      ...
      items: [
        {
          ...
          link: {
            type: 'doc',
            id: 'migration-guides/5x/index',
          },
          items: [{ type: 'autogenerated', dirName: 'migration-guides/5x' }],
        },
        {
          type: 'category',
          label: '3.x -> 4.x',
          ...
          link: {
            type: 'doc',
            id: 'migration-guides/4x/index',
          },
          items: [{ type: 'autogenerated', dirName: 'migration-guides/4x' }],
        },
        {
          type: 'category',
          label: '2.x -> 3.x',
