...
RequestType.Interaction -> RequestType.INTERACTION
RequestType.Compute -> RequestType.COMPUTE
RequestType.Prefetch -> RequestType.PREFETCH
RequestType.Thumbnail -> RequestType.THUMBNAIL

To match the rest of the library for enums
