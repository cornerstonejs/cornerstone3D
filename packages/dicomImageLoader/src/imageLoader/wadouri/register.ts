...
export default function (options?: {
   ...
   * Use addPart10Instance from @cornerstonejs/metadata to register
   * Part 10 binary metadata directly into the NATURAL cache instead.
   */
  console.warn(
    'wadouri metaDataProvider is deprecated. Use addPart10Instance from @cornerstonejs/metadata instead.'
  );
