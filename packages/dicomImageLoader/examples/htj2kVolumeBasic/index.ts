...
// The Juno CT's primary frames/ are JPEG-LS lossless, not HTJ2K, so every HTJ2K
// configuration has to retrieve from the htj2k/ rendition; reading primary
// frames/ would exercise JPEG-LS instead. A retrieve type with no entry of its
// own falls back to `default`.
