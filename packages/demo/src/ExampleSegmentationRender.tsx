...
class SegmentationExample extends Component {
  ...
  createNewLabelmapForScissors = async () => {
    ...
    segmentation
      ...
      .then((segmentationId) => {
        segmentation.setSegmentationRepresentations(
  ...
  loadSegmentation = async (segmentationId, initialConfig) => {
    ...
    // if (!initialConfig) {
    //   await segmentation.setSegmentationRepresentations(toolGroupId, [
    //     {
    //       volumeId: segmentationId,
    //       active: true,
    //       representation: {
    ...
    //   ])
    // } else {
    //   await segmentation.setSegmentationRepresentations(
    //     toolGroupId,
    //     [
    //       {
    //         type: csToolsEnums.SegmentationRepresentations.Labelmap,
          ...
          <div style={{ marginTop: '15px' }}>
            ...
            <button
              onClick={async () => {
                ...
                segmentation
                  .setSegmentationRepresentations(toolGroupId, [
                    {
