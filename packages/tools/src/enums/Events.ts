...
enum Events {
  ...
  ZOOM_TOOL_CHANGED = 'CORNERSTONE_TOOLS_ZOOM_TOOL_CHANGED',

  PAN_TOOL_CHANGED = 'CORNERSTONE_TOOLS_PAN_TOOL_CHANGED',

  TRACKBALLROTATE_TOOL_CHANGED = 'CORNERSTONE_TOOLS_TRACKBALLROTATE_TOOL_CHANGED',
