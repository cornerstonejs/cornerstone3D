...
function renderContourBeingEdited(
  enabledElement,
  svgDrawingHelper,
  annotation
) {
  // TODO_JAMES
  console.log('TODO_JAMES => renderContourBeingEdited');
}
...
function registerRenderMethods(toolInstance) {
  ...
  toolInstance.renderContourBeingEdited =
    renderContourBeingEdited.bind(toolInstance);
