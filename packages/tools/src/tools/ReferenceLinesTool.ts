...
/**
 * ReferenceLines let you draw annotations that measures the length of two drawing
 * points on a slice. You can use the ReferenceLines in all imaging planes even in oblique
 ...
 *
 * toolGroup.setToolActive(ReferenceLines.toolName, {
 *   bindings: [
 *    {
...
class ReferenceLines extends AnnotationTool {
  static toolName;
