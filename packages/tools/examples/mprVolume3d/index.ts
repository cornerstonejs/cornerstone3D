...
setTitleAndDescription(
  'MPR volume-3d',
  'PT-CT fusion volume3d layout with Crosshairs, synchronized cameras, jump to click and voiSync'
);
...
instructions.innerText = `
  ...
  - Middle click: Jump all views to the point of highest SUV in the region clicked.
  - Right click: Pan
  - Left click: Trackball Rotate 
  `;
