...
// ======== Set up page ======== //
setTitleAndDescription(
  'Basic Labelmap Segmentation with Different Cursor Strategies',
  'Here we demonstrate the use of different cursor strategies for the Brush Segmentation Tool. Use the dropdown to select between a circular and square brush.'
);
...
const brushStrategies = {
  ...
  [brushInstanceNames.SquareBrush]: 'FILL_INSIDE_SQUARE',
};

const brushValues = [
  brushInstanceNames.CircularBrush,
  brushInstanceNames.SquareBrush,
];
...
async function run() {
  ...
  toolGroup.addToolInstance(
    ...
    BrushTool.toolName,
    {
      activeStrategy: brushStrategies.SquareBrush,
    }
  );
